...
<a className="text-on-secondary-container dark:text-on-primary-container hover:text-healing-sage transition-colors duration-300 font-label-lg text-label-lg" href="#">About</a>
<a className="text-on-secondary-container dark:text-on-primary-container hover:text-healing-sage transition-colors duration-300 font-label-lg text-label-lg" href="#">Services</a>
<a className="text-on-secondary-container dark:text-on-primary-container hover:text-healing-sage transition-colors duration-300 font-label-lg text-label-lg" href="#">Education</a>
<a className="text-primary dark:text-primary-fixed-dim border-b-2 border-healing-sage pb-1 hover:text-healing-sage transition-colors duration-300 font-label-lg text-label-lg opacity-80 transition-opacity duration-200" href="#">Podcast</a>
<a className="text-on-secondary-container dark:text-on-primary-container hover:text-healing-sage transition-colors duration-300 font-label-lg text-label-lg" href="#">Resources</a>
<a className="inline-flex items-center justify-center px-8 py-3 bg-primary text-on-primary rounded-full hover:bg-ether-indigo-light transition-all duration-300 font-label-lg text-label-lg" href="#">
                    Book a Session
                </a>
</div>
<!-- Mobile Menu Toggle -->
...
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Addiction Recovery</a>
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Ayurvedic Healing</a>
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Reflexology</a>
</div>
<div className="flex flex-col gap-4">
<h4 className="font-label-lg text-label-lg text-primary font-semibold mb-2">Exploration</h4>
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Yoga &amp; Breathwork</a>
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Tarot</a>
<a className="text-primary dark:text-primary-fixed-dim font-semibold font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Podcast</a>
</div>
<div className="flex flex-col gap-4">
<h4 className="font-label-lg text-label-lg text-primary font-semibold mb-2">Connect</h4>
<a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 font-body-md text-body-md focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Professional Training</a>
