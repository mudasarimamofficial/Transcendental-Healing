...
export default function Page() {
 ...
 TopNavBar Component 
<header className="fixed top-0 w-full z-50 bg-surface-cream/90 border-b border-secondary-container/30 backdrop-blur-md dark:bg-primary/80 transition-all duration-300">
...
<!-- Mobile Menu Button (simplified for template) -->
...
<div className="absolute top-0 left-0 h-full bg-tertiary-fixed-dim w-1/3 rounded-full"></div>
</div>
</div>
<!-- Controls -->
...
<!-- Decorative element -->
<div className="absolute top-0 right-0 w-32 h-32 bg-healing-sage/10 rounded-bl-[100px] -mr-8 -mt-8"></div>
...
<button className="bg-tertiary-fixed-dim text-on-tertiary-container px-8 py-4 rounded-full font-label-lg text-label-lg hover:bg-tertiary-fixed transition-colors duration-300 whitespace-nowrap" type="button">
 ...
 Footer Component 
<footer className="w-full pt-20 pb-10 bg-surface dark:bg-primary-container border-t border-secondary-container mt-auto">
...
<p className="font-body-md text-body-md text-secondary dark:text-on-secondary-container">
                    A digital sanctuary for profound emotional and spiritual recovery.
                </p>
</div>
...
<a className="font-body-md text-body-md text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Tarot</a>
...
<a className="font-body-md text-body-md text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Contact Us</a>
</div>
</div>
...
<span className="font-body-md text-body-md text-secondary dark:text-on-secondary-container">
