...
<div className="min-w-[300px] md:min-w-[350px] bg-surface-cream rounded-2xl overflow-hidden border border-secondary-fixed snap-start group cursor-pointer hover:shadow-[0_20px_40px_-15px_rgba(26,31,53,0.08)] transition-all duration-300">
<div className="h-48 overflow-hidden relative">
<Image fill className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" data-alt="A soft, out-of-focus background of dense forest bathed in warm, golden hour light. The image feels grounding, safe, and deeply rooted in nature. Rich greens of healing sage mixing with deep browns. Expensive, sanctuary-like atmosphere." src="https://lh3.googleusercontent.com/aida-public/AB6AXuC720lr63xRbpWyCcMXCNV8fbDHCaDD5ALTLWpPC10Ep1hAHxLNQnZxPJOsEv_j20pabg_V-z4IT6BPNelGhqO3iQBFuq-8lJzNNxTDUj_70JMeRekr2-9WnNaf-38D5K4JD4Q2xdi03ifN4kOrH-H1OtYKGXYUPqdI3oi8SvkQIcFHGIZUjilZzOaXV2gNNSk5KWFVBQlndLelwjDnBlThB1hjOAtAQ6utoR8TuIA34c2KUue7lpAOL6DXpV11InM1qtiO43G8pL6i"/>
<div className="absolute inset-0 bg-primary/10 group-hover:bg-transparent transition-colors duration-300"></div>
<div className="absolute bottom-4 left-4 bg-surface-cream/90 backdrop-blur-sm px-3 py-1 rounded-full font-label-sm text-label-sm text-primary flex items-center gap-1">
<span className="material-symbols-outlined text-[14px]">play_circle</span>
                                41 min
