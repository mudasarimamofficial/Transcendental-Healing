    ...
    <section className="py-24 md:py-32 bg-background">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="relative">
          {/* Connecting Line */}
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-[1px] bg-secondary-container -translate-y-1/2 z-0" />
  ...
  <footer className="bg-surface dark:bg-primary-container w-full pt-20 pb-10 bg-surface-cream border-t border-secondary-container">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      ...
      <div className="col-span-1 md:col-span-1">
        ...
        <ClientFormWrapper className="space-y-3" onsubmit="event.preventDefault();">
