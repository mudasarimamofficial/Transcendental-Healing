...
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Home</a></li>
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">About</a></li>
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Services</a></li>
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Education</a></li>
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Podcast</a></li>
<li><a className="font-label-lg text-label-lg text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="#">Resources</a></li>
</ul>
...
<input className="peer sr-only" name="service" type="radio" value="clinical"/>
...
<div className="w-2.5 h-2.5 rounded-full bg-surface-container-lowest opacity-0 peer-checked:opacity-100"></div>
</div>
</div>
</div>
</label>
<!-- Option B -->
<label className="cursor-pointer group relative h-full">
<input checked="" className="peer sr-only" name="service" type="radio" value="sacred"/>
...
<div className="w-2.5 h-2.5 rounded-full bg-surface-container-lowest opacity-100"></div>
</div>
</div>
</div>
</label>
<!-- Option C -->
<label className="cursor-pointer group relative h-full">
<input className="peer sr-only" name="service" type="radio" value="spiritual"/>
<div className="h-full rounded-xl border border-secondary-container bg-surface-container-lowest p-6 transition-all duration-300 peer-checked:border-tertiary-fixed-dim peer-checked:bg-surface-cream peer-checked:shadow-[0_4px_24px_rgba(233,193,118,0.15)] group-hover:border-outline-variant flex flex-col justify-between">
<div>
<div className="w-12 h-12 rounded-full bg-surface-container flex items-center justify-center mb-4 text-primary group-hover:text-healing-sage transition-colors peer-checked:text-tertiary-fixed-dim">
...
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Addiction Recovery</a></li>
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Ayurvedic Healing</a></li>
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Reflexology</a></li>
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Yoga &amp; Breathwork</a></li>
</ul>
</div>
<div>
<h4 className="font-label-lg text-label-lg text-primary mb-4 font-semibold">Connect</h4>
<ul className="space-y-3">
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Tarot</a></li>
<li><a className="font-body-md text-body-md text-secondary hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage block" href="#">Professional Training</a></li>
