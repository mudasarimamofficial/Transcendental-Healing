...
<a className="font-body-md text-body-md tracking-wide text-on-surface-variant hover:text-tertiary-fixed-dim transition-all duration-300" href="#">About</a>
<a className="font-body-md text-body-md tracking-wide text-primary border-b border-tertiary-fixed-dim pb-1 hover:text-tertiary-fixed-dim transition-all duration-300" href="#">Services</a>
...
<a className="font-body-md text-body-md tracking-wide text-on-surface-variant hover:text-tertiary-fixed-dim transition-all duration-300" href="#">Podcast</a>
</nav>
...
<li><a className="font-label-lg text-label-lg text-secondary hover:text-primary underline-offset-4 hover:underline transition-all duration-300 ease-in-out" href="#">About</a></li>
<li><a className="font-label-lg text-label-lg text-secondary hover:text-primary underline-offset-4 hover:underline transition-all duration-300 ease-in-out" href="#">Services</a></li>
<li><a className="font-label-lg text-label-lg text-secondary hover:text-primary underline-offset-4 hover:underline transition-all duration-300 ease-in-out" href="#">Podcast</a></li>
</ul>
</div>
<div className="col-span-1">
