...
export default function Page() {
  return (
    <div className="bg-surface-cream text-on-surface font-body-md min-h-screen flex flex-col antialiased selection:bg-healing-sage/30 selection:text-primary">
<div>
  ...
  <main className="flex-grow pt-32 pb-24 px-margin-mobile md:px-margin-desktop w-full max-w-container-max mx-auto relative">
    ...
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-primary-fixed/20 rounded-full blur-[120px] -z-10 pointer-events-none opacity-50" />
    {/* Hero Section */}
    <section className="text-center mb-16 md:mb-24 animate-fade-in" style={{animationDelay: '0.1s'}}>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
      ...
      <div className="lg:col-span-7 animate-fade-in" style={{animationDelay: '0.2s'}}>
        <div className="bg-surface-container-lowest border border-secondary-fixed p-8 md:p-12 rounded-2xl">
          ...
          <ClientFormWrapper action={submitContactForm} className="space-y-8">
            {/* Name Input */}
            <div className="relative">
              <input className="floating-input peer block w-full appearance-none border-0 border-b border-secondary-fixed bg-transparent px-0 py-3 text-on-surface focus:border-healing-sage focus:outline-none focus:ring-0 transition-colors" id="name" name="name" placeholder=" " required type="text" />
            ...
            {/* Email Input */}
            <div className="relative">
              <input className="floating-input peer block w-full appearance-none border-0 border-b border-secondary-fixed bg-transparent px-0 py-3 text-on-surface focus:border-healing-sage focus:outline-none focus:ring-0 transition-colors" id="email" name="email" placeholder=" " required type="email" />
            ...
            <div className="relative border-b border-secondary-fixed pb-2">
              ...
              <select className="block w-full appearance-none border-0 bg-transparent px-0 py-2 text-on-surface focus:ring-0 focus:outline-none cursor-pointer" id="service_type" name="service_type">
            ...
            <div className="relative pt-4">
              <textarea className="floating-input peer block w-full appearance-none border-0 border-b border-secondary-fixed bg-transparent px-0 py-3 text-on-surface focus:border-healing-sage focus:outline-none focus:ring-0 transition-colors resize-none" id="message" name="message" placeholder=" " rows={4} defaultValue={""} />
