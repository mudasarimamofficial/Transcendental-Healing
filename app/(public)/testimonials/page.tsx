...
<div className="group cursor-pointer relative overflow-hidden rounded-xl border border-secondary-fixed">
<div className="aspect-[4/3] relative">
<Image fill className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Close up of hands gently holding a small, glowing crystal during a holistic therapy session. The background is softly blurred out, showing warm, muted tones of a healing sanctuary. The mood is intimate, focused, and deeply spiritual, aligning with the premium, minimalist aesthetic of the brand." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbNivFyS77ZejHGSanh9kVBXmE8b6M_7Yte1pxJV6Yrpy_o251sIltit4xiQSDOUqyxOFaYFq91AGJH2dqHxIegon3w9oxBSASRY7AB1GkfAB2Bej8a7fVS5ouInHCXqXBqfKgNg1BLCfBiDlNOvgt4wog6FhG8KWcDuddzJHzinKGu46bZOLnLdD-Zd7ufW9Wm1uGG0E0nF86HFJJrmiRI_nGDHMUGMF1hVNwN-ZrkLH0rGSvguUXBRDj3JNHtbkmQjwEhSjyvCPG"/>
<div className="absolute inset-0 bg-primary/20 group-hover:bg-primary/10 transition-colors duration-300"></div>
<div className="absolute inset-0 flex items-center justify-center">
<div className="w-16 h-16 rounded-full bg-surface-cream/80 blur-overlay flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300">
<span className="material-symbols-outlined text-primary fill-icon text-[32px] ml-1">play_arrow</span>
