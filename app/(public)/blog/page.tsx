...
export default function Page() {
  return (
    <div className="bg-background text-on-background antialiased font-body-md text-body-md selection:bg-tertiary-fixed-dim selection:text-tertiary">
<div>
  {/* TopNavBar */}
  <nav className="fixed top-0 w-full z-50 bg-surface-cream/80 backdrop-blur-md dark:bg-primary/80 bg-surface-cream/90 border-b border-secondary-container/30">
    <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
      ...
      <div className="hidden md:flex items-center space-x-8">
        ...
        <a className="font-label-lg text-label-lg text-primary dark:text-primary-fixed-dim border-b-2 border-healing-sage pb-1 Active: opacity-80 transition-opacity duration-200" href="/continuing-education">Education</a>
    ...
    <section className="py-16 bg-surface-cream border-y border-secondary-fixed">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-secondary-fixed/50">
          ...
          <div className="text-center px-4 fade-in-up" style={{transitionDelay: '100ms'}}>
          ...
          <div className="text-center px-4 fade-in-up" style={{transitionDelay: '200ms'}}>
          ...
          <div className="text-center px-4 fade-in-up" style={{transitionDelay: '300ms'}}>
    ...
    <section className="py-24 md:py-32 px-margin-mobile md:px-margin-desktop bg-background" id="catalog">
      <div className="max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter auto-rows-[minmax(180px,auto)]">
          ...
          {/* Course 2 (Medium) */}
          <article className="md:col-span-4 md:row-span-1 bg-surface-cream rounded-xl border border-secondary-fixed p-8 flex flex-col fade-in-up" style={{transitionDelay: '100ms'}}>
          ...
          {/* Course 3 (Medium) */}
          <article className="md:col-span-4 md:row-span-1 bg-surface-container-low rounded-xl border border-secondary-fixed p-8 flex flex-col fade-in-up" style={{transitionDelay: '200ms'}}>
            <div className="flex justify-between items-start mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-surface-cream p-8 border border-secondary-fixed rounded-xl fade-in-up">
            ...
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-secondary-container mr-4" />
              <div>
          ...
          {/* Testimonial 2 */}
          <div className="bg-surface-cream p-8 border border-secondary-fixed rounded-xl fade-in-up" style={{transitionDelay: '100ms'}}>
            <div className="text-healing-sage mb-6">
              <span className="material-symbols-outlined fill text-[32px]">format_quote</span>
            </div>
            <p className="font-body-md text-body-md text-primary mb-8 min-h-[120px]">
          ...
          {/* Testimonial 3 */}
          <div className="bg-surface-cream p-8 border border-secondary-fixed rounded-xl fade-in-up" style={{transitionDelay: '200ms'}}>
            <div className="text-healing-sage mb-6">
              <span className="material-symbols-outlined fill text-[32px]">format_quote</span>
            </div>
            <p className="font-body-md text-body-md text-primary mb-8 min-h-[120px]">
      ...
      <div className="col-span-1 md:col-span-2 grid grid-cols-2 gap-8">
        <div>
          ...
          <ul className="space-y-3 font-body-md text-body-md">
            <li><a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/services/addiction-recovery">Addiction Recovery</a></li>
            <li><a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/services/ayurveda">Ayurvedic Healing</a></li>
            <li><a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/services/reflexology">Reflexology</a></li>
            <li><a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/services/yoga">Yoga &amp; Breathwork</a></li>
            <li><a className="text-secondary dark:text-on-secondary-container hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/services/tarot">Tarot</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-label-lg text-label-lg text-primary mb-4 uppercase tracking-wider">Education</h4>
          <ul className="space-y-3 font-body-md text-body-md">
            <li><a className="text-primary dark:text-primary-fixed-dim font-semibold focus:outline-none focus:ring-1 focus:ring-healing-sage" href="/continuing-education">Professional Training</a></li>
