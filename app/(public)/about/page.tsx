...
<a className="text-primary border-b border-tertiary-fixed-dim pb-1 font-body-md text-body-md tracking-wide" href="#">About</a>
<a className="text-on-surface-variant hover:text-tertiary-fixed-dim transition-all duration-300 font-body-md text-body-md tracking-wide" href="#">Services</a>
...
<a className="text-on-surface-variant hover:text-tertiary-fixed-dim transition-all duration-300 font-body-md text-body-md tracking-wide" href="#">Podcast</a>
</div>
