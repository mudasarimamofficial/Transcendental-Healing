...
<div>
  {/* TopNavBar (from JSON) */}
  <nav className="w-full sticky top-0 z-50 bg-surface-bright/80 dark:bg-primary-container/80 backdrop-blur-md">
    <div className="flex justify-between items-center px-margin-desktop py-4 max-w-container-max mx-auto md:px-margin-desktop px-margin-mobile">
      <div className="font-display-lg text-headline-md tracking-tighter text-primary dark:text-primary-fixed">
        Ethereal Sanctum
      </div>
  ...
  <main className="flex-grow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-surface-cream rounded-xl p-10 border border-secondary-container hover:shadow-2xl transition-shadow duration-500 flex flex-col items-start group">
          <div className="w-16 h-16 rounded-full bg-surface-bright flex items-center justify-center mb-8 border border-secondary-container group-hover:border-tertiary-fixed-dim transition-colors">
            <span className="material-symbols-outlined text-primary" style={{fontSize: 32, fontVariationSettings: '"FILL" 0'}}>psychology</span>
          </div>
        ...
        <div className="bg-primary text-on-primary rounded-xl p-10 shadow-lg flex flex-col items-start relative overflow-hidden">
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-ether-indigo-light rounded-full blur-3xl opacity-50" />
          <div className="w-16 h-16 rounded-full bg-primary-container flex items-center justify-center mb-8 border border-ether-indigo-light relative z-10">
            <span className="material-symbols-outlined text-tertiary-fixed-dim" style={{fontSize: 32, fontVariationSettings: '"FILL" 1'}}>spa</span>
          </div>
        ...
        <div className="bg-surface-cream rounded-xl p-10 border border-secondary-container hover:shadow-2xl transition-shadow duration-500 flex flex-col items-start group">
          <div className="w-16 h-16 rounded-full bg-surface-bright flex items-center justify-center mb-8 border border-secondary-container group-hover:border-tertiary-fixed-dim transition-colors">
            <span className="material-symbols-outlined text-primary" style={{fontSize: 32, fontVariationSettings: '"FILL" 0'}}>diversity_1</span>
          </div>
    ...
    <section className="py-24 md:py-32 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center">
      <div className="max-w-3xl mx-auto space-y-12">
        <span className="material-symbols-outlined text-tertiary-fixed-dim opacity-50" style={{fontSize: 48}}>flare</span>
        <div>
    ...
    <section className="py-32 bg-primary text-on-primary text-center px-margin-mobile relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMjAiIGN5PSIyMCIgcj0iMSIgZmlsbD0iI2ZmZiIgZmlsbC1vcGFjaXR5PSIwLjEiLz48L3N2Zz4=')]" />
  ...
  {/* Footer (from JSON) */}
  <footer className="w-full pt-20 pb-10 bg-surface-cream dark:bg-inverse-surface">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
      <div className="col-span-1 md:col-span-2 space-y-4">
        <div className="font-display-lg text-headline-md text-primary dark:text-primary-fixed">
          Ethereal Sanctum
        </div>
        <p className="font-body-md text-body-md text-secondary dark:text-secondary-fixed max-w-sm">
          A digital sanctuary blending clinical authority with spiritual healing.
        </p>
      </div>
      <div className="col-span-1 space-y-4">
        <h4 className="font-label-lg text-label-lg text-primary dark:text-primary-fixed uppercase tracking-wider">Navigation</h4>
        <ul className="space-y-2 flex flex-col">
          <a className="font-label-lg text-label-lg text-secondary dark:text-secondary-fixed hover:text-primary dark:hover:text-primary-fixed-dim underline-offset-4 hover:underline Transition-all duration-300 ease-in-out" href="#">Quick Links</a>
          <a className="font-label-lg text-label-lg text-secondary dark:text-secondary-fixed hover:text-primary dark:hover:text-primary-fixed-dim underline-offset-4 hover:underline Transition-all duration-300 ease-in-out" href="#">Legal</a>
          <a className="font-label-lg text-label-lg text-secondary dark:text-secondary-fixed hover:text-primary dark:hover:text-primary-fixed-dim underline-offset-4 hover:underline Transition-all duration-300 ease-in-out" href="#">Newsletter Signup</a>
        </ul>
      </div>
      <div className="col-span-1 flex flex-col justify-end mt-12 md:mt-0">
        <p className="font-label-sm text-label-sm text-secondary dark:text-secondary-fixed">
