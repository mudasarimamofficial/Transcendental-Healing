...
<a className="font-label-lg text-label-lg text-primary dark:text-primary-fixed-dim border-b-2 border-healing-sage pb-1 hover:text-healing-sage transition-colors duration-300 opacity-80" href="#">Resources</a>
</nav>
<a className="hidden md:inline-block px-8 py-3 bg-primary text-surface-cream font-label-lg text-label-lg rounded hover:bg-tertiary transition-colors duration-300" href="#">
                Book a Session
            </a>
</div>
</header>
...
<div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-tertiary-fixed/30 rounded-full blur-[120px] -z-10 pointer-events-none"></div>
...
<div className="absolute top-0 right-0 w-64 h-64 bg-healing-sage/10 rounded-full blur-[80px] pointer-events-none"></div>
...
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Addiction Recovery</a></li>
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Ayurvedic Healing</a></li>
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Reflexology</a></li>
</ul>
</div>
<div className="md:col-span-1">
<h4 className="font-label-lg text-label-lg text-primary dark:text-primary-fixed-dim font-semibold mb-4">Practices</h4>
<ul className="space-y-3">
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Yoga &amp; Breathwork</a></li>
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Tarot</a></li>
</ul>
</div>
<div className="md:col-span-1">
<h4 className="font-label-lg text-label-lg text-primary dark:text-primary-fixed-dim font-semibold mb-4">Connect</h4>
<ul className="space-y-3">
<li><a className="text-secondary dark:text-on-secondary-container font-body-md text-body-md hover:text-healing-sage transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-healing-sage rounded" href="#">Professional Training</a></li>
